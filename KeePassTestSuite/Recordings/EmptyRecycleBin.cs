...
#region Variables
        ...
        void ITestModule.Run()
        {
            ...
            try {
                Report.Log(ReportLevel.Info, "Mouse", "(Optional Action)\r\nMouse Left Click item 'KeePassApplication.ButtonDelete' at Center.", repo.KeePassApplication.ButtonDeleteInfo, new RecordItemIndex(2));
                repo.KeePassApplication.ButtonDelete.Click();
                Delay.Milliseconds(200);
